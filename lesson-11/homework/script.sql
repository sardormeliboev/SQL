...
Lesson 11 — Homework Tasks with SQL Solutions
🟢 Easy-Level Tasks (1–7)

1. Eng katta oylikni topish

SELECT MAX(Salary) AS MaxSalary
FROM Employees;


2. Eng kichik oylikni topish

SELECT MIN(Salary) AS MinSalary
FROM Employees;


3. O‘rtacha oylikdan yuqori maosh oladigan xodimlar
...
4. Eng ko‘p oylik oladigan xodim(lar)
...
5. Eng kam oylik oladigan xodim(lar)
...
6. "Sales" bo‘limidagi o‘rtacha oylik
...
7. Eng ko‘p oylik oladigan bo‘lim nomi
...
🟡 Medium-Level Tasks (8–14)

8. O‘z bo‘limidagi o‘rtacha oylikdan yuqori oladigan xodimlar
...
10. Mahsulot buyurtma qilmagan ta’minotchilar
...
12. Hech kursga yozilmagan talabalar
...
13. Eng ko‘p buyurtma qilgan mijoz(lar)
...
14. Eng ko‘p buyurtma qilingan mahsulot
...
🔴 Hard-Level Tasks (15–20)

15. Oyligi barcha bo‘limlardagi o‘rtacha oylikdan yuqori bo‘lgan xodimlar
...
16. Oyligi barcha bo‘limlardagi o‘rtacha oylikdan past bo‘lgan xodimlar
...
17. Hech qachon buyurtma qilinmagan mahsulotlar
...
18. O‘z bo‘limidagi eng katta oylikni oladigan xodimlar
...
19. Har bir bo‘limdagi eng katta oylikni ko‘rsatish
...
20. Oyligi o‘z bo‘limidagi eng katta oylikka teng bo‘lgan xodimlar
